 ...
 * @param <K, T> data type
 */
public class NodeQ3<K extends Comparable<K>, T>
{
	ColorQ1 color;			// Node color
	K key;					// Node key
	T data;					// Node associated data
	NodeQ3<K, T> parent; 		// Parent node
	NodeQ3<K, T> left, right; 	// Children nodes

	public NodeQ3(K key, T data)
	{
		this.key  	= key;
		this.data  	= data;
		...
		this.left 			= new NodeQ3<K, T>();  //leaf node
		this.right 			= new NodeQ3<K, T>();  //leaf node
